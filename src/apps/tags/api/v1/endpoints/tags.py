...
@router.patch(
    ...
    description=(
        "Обновляет данные тега по указанному идентификатору. " "Возвращает обновлённый объект."
    ),
)
...
async def delete_tag(tag_id: UUID, service_manager: Service = Depends(get_service_manager)):
